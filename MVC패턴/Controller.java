...
public class Controller {
	...
	// View로부터 데이터를 받아서 가공 or 처리하는 역할
	// Model의 데이터를 수정하거나 가지고 오는 역할 수행
	// View에 결과를 전달

	// 곡(Model) 5개를 저장하는 ArrayList 생성
	...
	public Controller() {
		...
		musicList.add(new Model("ditto", "뉴진스", 50, "music/ditto.mp3"));
		musicList.add(new Model("hypeboy", "뉴진스", 70, "music/hypeboy.mp3"));
		musicList.add(new Model("OMG", "뉴진스", 40, "music/OMG.mp3"));
	}
